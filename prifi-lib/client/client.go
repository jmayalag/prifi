...
func (p *PriFiLibClientInstance) Received_ALL_CLI_SHUTDOWN(msg net.ALL_ALL_SHUTDOWN) error {
...
func (p *PriFiLibClientInstance) Received_ALL_CLI_PARAMETERS(msg net.ALL_ALL_PARAMETERS_NEW) error {
